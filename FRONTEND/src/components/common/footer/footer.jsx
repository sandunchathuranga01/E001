					...
					<div class="widget widget_contact">
						...
						<div class="contact_info">
							<div class="single_info">
								...
								<div class="info">
									<p><a href="tel:+94112 413 779">+94 12 456 8191</a></p>
									<p><a href="tel:+94777272284">+94 12 456 8191</a></p>
								</div>
							</div>
							<div class="single_info">
								<div class="icon">
								...
								<div class="info">
									...
									<p><a href="ceylonherbcare.lk@gmail.com">example@gmail.com</a></p>
								</div>
							</div>
							<div class="single_info">
								<div class="icon">
								...
								<div class="info fot_add">
									<p>379/9 Pahan Uyana<span> Colombo, Sri Lanka.</span></p>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="copyright_text">
						<p>Copyright &copy; 2025 All rights reserved | Vebusa.com</p>
					</div>
				</div>
			</div>
		</div>
